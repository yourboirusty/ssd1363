...
//!
//! TODO!: update this
//! See the [example](https://github.com/antonok-edm/1363/blob/master/examples/graphics.rs)
...
//! [the examples/ folder](https://github.com/antonok-edm/1363/blob/master/examples)
//!
...
//! use 1363::{mode::GraphicsMode, Builder};
//!
//! fn main() {
